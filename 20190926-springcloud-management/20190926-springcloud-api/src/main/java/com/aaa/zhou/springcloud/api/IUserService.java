...
import com.aaa.zhou.springcloud.fallback.IUserServiceFallBackFactory;
...
public interface IUserService {
     ...
     * @author zhoulinhao
     * @description 基本类型参数使用@RequestParam   List<User> selectAllUsers(@RequestParam Integer id);
